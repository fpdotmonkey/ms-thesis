# Comments for Overleaf template

Updated at 31 May 2017

Modifications were kept to a minimum. No modifications were done
on the `aaltothesis.cls' file. You might want to update some of the 
files from original URL. You might also need to download a newer
version of `aaltologo.sty' file.

Template: https://wiki.aalto.fi/display/Aaltothesis/Aalto+Thesis+LaTeX+Template
Logo package: https://version.aalto.fi/gitlab/latex/aaltologo/tree/master
